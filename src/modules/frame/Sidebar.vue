  ...
  data(){
    return{
      ...
      {users: 'ALL', description: 'Organizations', icon: 'fas fa-users', path: 'organizations', flag: false, subMenu: null},
        {users: 'ALL', description: 'Shop', icon: 'fas fa-store', path: 'marketplace', flag: false, subMenu: [{users: 'ALL', description: 'Marketplace', icon: 'fas fa-store', path: 'marketplace', flag: false}, {users: 'ALL', description: 'Products', icon: 'fa fa-shopping-cart', path: 'products', flag: false}, {users: 'ALL', description: 'Orders', icon: 'fa fa-file', path: 'orders', flag: false}, {users: 'ALL', description: 'Coupons', icon: 'fa fa-tags', path: 'coupons', flag: false}, {users: 'ALL', description: 'Wishlists', icon: 'fa fa-heart', path: 'wishlists', flag: false}]
        },
